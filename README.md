...
* As a proof-of-concept and exemplar for other companies worldwide, we can use all available de-identified GDPR-compliant IBM HR data from which we can use the most relevant schema for analytics; [many more additional columns than this ago IBM provision to Kaggle of course](https://www.kaggle.com/pavansubhasht/ibm-hr-analytics-attrition-dataset).
